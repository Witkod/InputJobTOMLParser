...
//szablon wywo³uje siê rekurencyjnie dla kolejnych typów podanych w argumentach T
//Dopóki nie znajdzie typu, który daje siê rzutowaæ na typ akceptowany w TOML
template <class T, class... Ts>
struct value_accept<T, Ts...>
{
	//metoda statyczna wiêc mo¿na j¹ inicjowaæ po zdefiniowaniu klasy
	// wywo³uje przeci¹¿on¹ funkcjê visit w przekazanej przez nas klasie Visitor
    template <class Visitor, class... Args>
 ...
 * class.
 */
// metoda klasy base do wywo³ywania przez nas zdefiniowanej klasy visitor,
// która ma przeci¹¿on¹ funkcjê visit()
template <class Visitor, class... Args>
